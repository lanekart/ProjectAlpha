...
from alpha.application.decision_superiority_entry_stop_improvement_cli import (
...
from alpha.application.decision_superiority_regime_strategy_cli import (
    register_decision_superiority_regime_strategy_command,
)
from alpha.application.decision_superiority_snapshot_retention_cli import (
...
from alpha.application.governed_adaptive_institutional_trade_shadow_cli import (
...
from alpha.application.governed_setup_matched_evidence_cli import (
...
register_governed_adaptive_institutional_trade_shadow_command(benchmark_app)
