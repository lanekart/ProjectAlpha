    ...
    def score(
        ...
        *,
        ...
        breakdown = RecommendationScoreBreakdown(
            strategy_points=_quantize(candidate.strategy_score * Decimal("25")),
            probability_points=_quantize(candidate.probability_score * Decimal("25")),
            market_intelligence_points=_quantize(
                candidate.market_intelligence_score * Decimal("25")
            ),
            liquidity_points=_quantize(candidate.liquidity_score * Decimal("15")),
            risk_points=_quantize((candidate.risk_score - _ONE) * Decimal("10")),
