...
class ValidationOutcome(StrEnum):
    ...
    FACTOR_CONFIRMED_CORRECT_EVENT_DATE_OFFSET = "FACTOR_CONFIRMED_CORRECT_EVENT_DATE_OFFSET"
    FACTOR_CONFIRMED_CORRECT_MULTIPLE_ACTIONS = "FACTOR_CONFIRMED_CORRECT_MULTIPLE_ACTIONS"
...
class MixedBasisResolution(StrEnum):
    ...
    ADJUSTED_WITH_SEGMENTED_UNCERTIFIED_INTERVAL = "ADJUSTED_WITH_SEGMENTED_UNCERTIFIED_INTERVAL"
...
class AdmissionState(StrEnum):
    ...
    ADJUSTED_REPLAY_CERTIFIED_TRADABILITY_PARTIAL = "ADJUSTED_REPLAY_CERTIFIED_TRADABILITY_PARTIAL"
...
class ReplayReadiness(StrEnum):
    ...
    CONDITIONALLY_READY_FOR_ADJUSTED_REPLAY_INTEGRATION = "CONDITIONALLY_READY_FOR_ADJUSTED_REPLAY_INTEGRATION"
    NOT_READY_FOR_ADJUSTED_REPLAY_INTEGRATION = "NOT_READY_FOR_ADJUSTED_REPLAY_INTEGRATION"
